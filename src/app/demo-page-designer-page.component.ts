      ...
      <thy-card thyBordered="false" class="traceback-panel">
        <div class="traceback-panel__header">
          ...
          <label class="traceback-panel__toggle">
            <input
              type="checkbox"
              [ngModel]="autoSnapshot()"
              (ngModelChange)="setAutoSnapshot($event)"
            />
