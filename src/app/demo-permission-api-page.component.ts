...
import {
  DemoPermissionApiConfig,
  DemoPermissionScope,
  DemoWorkspaceService,
} from './demo-workspace.service';
      ...
      <thy-card thyBordered="false" class="permission-page__panel">
        ...
        <div class="permission-page__grid">
          <label class="permission-page__field">
            ...
            <input
              [ngModel]="draft().queryEndpoint"
              (ngModelChange)="updateQueryEndpoint($event)"
            />
          </label>
          <label class="permission-page__field">
            <span>Mutation Endpoint</span>
            <input
              [ngModel]="draft().mutationEndpoint"
              (ngModelChange)="updateMutationEndpoint($event)"
            />
          </label>
          <label class="permission-page__field">
            <span>State Key: tenantId</span>
            <input
              [ngModel]="draft().stateKeys.tenantId"
              (ngModelChange)="updateStateKey('tenantId', $event)"
            />
          </label>
          <label class="permission-page__field">
            <span>State Key: userId</span>
            <input
              [ngModel]="draft().stateKeys.userId"
              (ngModelChange)="updateStateKey('userId', $event)"
            />
          </label>
          <label class="permission-page__field">
            <span>State Key: roles</span>
            <input
              [ngModel]="draft().stateKeys.roles"
              (ngModelChange)="updateStateKey('roles', $event)"
            />
          </label>
          <label class="permission-page__field">
      ...
      <thy-card thyBordered="false" class="permission-page__panel">
        ...
        <div class="permission-page__grid">
          ...
          <label class="permission-page__field">
            ...
            <select
              [ngModel]="draft().permissionScope"
              (ngModelChange)="updatePermissionScope($event)"
            >
          ...
          <label class="permission-page__field">
            ...
            <input
              [ngModel]="draft().selectedOrgId"
              (ngModelChange)="updateSelectedOrgId($event)"
            />
          </label>
          <label class="permission-page__field permission-page__field--full">
