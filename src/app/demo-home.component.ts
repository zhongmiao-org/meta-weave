      ...
      <thy-content class="demo-home__content">
        <div class="demo-home__hero">
          ...
          <div class="demo-home__hero-actions">
            ...
            <a thyButton="outline-primary" routerLink="/studio/permission">{{
              copy().workspaceNavPermission
            }}</a>
            <a thyButton="outline-primary" routerLink="/studio/page/designer">{{
        ...
        <div class="demo-home__cards">
          ...
          <thy-card thyBordered="false" class="demo-home__card">
            ...
            ></thy-card-header>
            <thy-card-content>
              <a thyButton="primary" routerLink="/studio/datasource">{{
          ...
          <thy-card thyBordered="false" class="demo-home__card">
            ...
            ></thy-card-header>
            <thy-card-content>
              <a thyButton="primary" routerLink="/studio/permission">{{
                copy().workspaceNavPermission
              }}</a>
            </thy-card-content>
          </thy-card>
          <thy-card thyBordered="false" class="demo-home__card">
            ...
            ></thy-card-header>
            <thy-card-content>
              <a thyButton="primary" routerLink="/studio/page/designer">{{
                copy().workspaceNavPage
              }}</a>
            </thy-card-content>
          </thy-card>
