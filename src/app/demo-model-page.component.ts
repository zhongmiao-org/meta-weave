      ...
      <thy-card thyBordered="false" class="workspace-page__panel">
        <div class="workspace-page__header">
          ...
          <div class="workspace-page__actions">
            <button thyButton="outline-primary" size="sm" (click)="workspace.addTable()">
              {{ copy().addTable }}
            </button>
            ...
            <div class="workspace-page__header">
              <div>
                ...
                <div class="workspace-page__tags">
                  ...
                  <thy-tag thyColor="info" thyTheme="weak-fill" thySize="sm">{{
                    table.kind
                  }}</thy-tag>
              ...
              <div class="workspace-page__actions">
                <button
                  ...
                  size="sm"
                  (click)="workspace.addColumn(table.id)"
                >
                  {{ copy().addColumn }}
                </button>
                <button
                  thyButton="outline-primary"
                  size="sm"
                  (click)="workspace.addChildTable(table.id)"
                >
                  {{ copy().addChildTable }}
                </button>
                <button
                  thyButton="outline-primary"
                  size="sm"
                  (click)="workspace.addIndex(table.id)"
                >
                  {{ copy().addIndex }}
                </button>
                <button
                  thyButton="outline-danger"
                  size="sm"
                  (click)="workspace.removeTable(table.id)"
                >
                  Delete
                </button>
              </div>
              ...
              @for (column of table.columns; track column.id) {
                <div class="workspace-page__row">
                  ...
                  <select
                    ...
                    [value]="column.type"
                    (change)="
                      workspace.setColumnType(
                        table.id,
                        column.id,
                        toColumnType($any($event.target).value)
                      )
                    "
                  >
                  ...
                  <thy-tags>
                    <thy-tag
                      [thyColor]="
                        column.primary ? 'danger' : column.required ? 'success' : 'default'
                      "
                      thyTheme="weak-fill"
                      thySize="sm"
                    >
                  ...
                  <label class="workspace-page__switch">
                    <input
                      ...
                      (change)="
                        workspace.setColumnPrimary(table.id, column.id, $any($event.target).checked)
                      "
                    />
                    Primary
                  </label>
                  <button
                    thyButton="outline-danger"
                    size="sm"
                    (click)="workspace.removeColumn(table.id, column.id)"
                  >
                    Delete
                  </button>
                </div>
        ...
        <div class="workspace-page__card">
          <div class="workspace-page__header">
            ...
            <div class="workspace-page__actions">
              <button thyButton="outline-primary" size="sm" (click)="addRelationRow()">
                Add Relation
              </button>
            </div>
          </div>
              ...
              @for (relation of workspace.metaModel().relations; track relation.id) {
                <div class="workspace-page__row">
                  ...
                  <select
                    ...
                    (change)="
                      workspace.updateRelation(relation.id, {
                        fromColumnId: $any($event.target).value,
                      })
                    "
                  >
                  ...
                  <select
                    ...
                    (change)="
                      workspace.updateRelation(relation.id, {
                        kind: toRelationKind($any($event.target).value),
                      })
                    "
                  >
                  ...
                  <select
                    ...
                    (change)="
                      workspace.updateRelation(relation.id, {
                        toColumnId: $any($event.target).value,
                      })
                    "
                  >
                  ...
                  <button
                    thyButton="outline-danger"
                    size="sm"
                    (click)="workspace.removeRelation(relation.id)"
                  >
                    Delete
                  </button>
                </div>
